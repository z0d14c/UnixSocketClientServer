...
string addFile() {
	...
	cin >> fileSelection;
	char localFilePath[sizeof(fileSelection)];
    strcpy(localFilePath, fileSelection.c_str()); // copy to result array
	...
	fileSelection += "###";
	return fileSelection; //format is "<filename>!!!<filecontent>###"
}
